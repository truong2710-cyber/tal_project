...
# runtime
train_cfg = dict(max_epochs=1500, val_interval=20, dynamic_intervals=[(800, 5)])

auto_scale_lr = dict(base_batch_size=256)

default_hooks = dict(
    checkpoint=dict(type='CheckpointHook', interval=40, max_keep_ckpts=15))
...
data_mode = 'bottomup'
data_root = '/workspace/mmpose/DATA/split_dataset/'
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='test/annotations/instances_val.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'test/annotations/instances_val.json',
    score_mode='bbox',
    nms_mode='none',
)
...
model = dict(
    ...
    head=dict(
        ...
        assigner=dict(
            ...
            oks_calculator=dict(type='PoseOKS', metainfo=metafile_path)), 
